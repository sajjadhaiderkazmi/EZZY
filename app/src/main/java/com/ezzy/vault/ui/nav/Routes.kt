...
object Routes {
    ...
    const val ITEM_GROUP = "itemGroup/{groupId}"
    fun itemGroup(groupId: String) = "itemGroup/$groupId"

    const val ITEM = "item/{itemId}"
    fun item(itemId: String) = "item/$itemId"

    const val EDITOR = "editor?itemId={itemId}&categoryId={categoryId}&templateId={templateId}"
    fun editor(itemId: String? = null, categoryId: String? = null, templateId: String? = null) =
